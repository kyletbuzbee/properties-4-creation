...
const propertiesData = [
    {
        ...
        location: 'Tyler, TX',
        image: 'public/images/properties/properties-tyler-ranch-home.webp'
    },
    {
        ...
        image: 'public/images/properties/properties-longview-victorian.webp'
    },
    {
        ...
        image: 'public/images/properties/properties-marshall-farmhouse.webp'
    },
    {
        name: 'Kemp Townhome',
        bedrooms: 2,
        ...
        location: 'Kemp, TX',
        image: 'public/images/properties/properties-kemp-townhome.webp'
    },
    {
        ...
        image: 'public/images/properties/properties-jefferson-river-front.webp'
    },
    {
        name: 'Mineola Studio',
        bedrooms: 1,
        ...
        location: 'Mineola, TX',
        image: 'public/images/properties/properties-mineola-studio.webp'
    }
];
...
if (sliderContainer) {
    ...
    const moveSlider = (e) => {
        ...
        sliderContainer.querySelector('.slider-after').style.clipPath = `inset(0 0 0 ${percentage}%)`;
    };
...
if (filterBtn) {
    filterBtn.addEventListener('click', () => {
        ...
        cards.forEach(card => {
            ...
            const location = card.querySelector('.property-content p').textContent.toLowerCase();
            ...
            const matchesSearch = !searchFilter || title.includes(searchFilter) || location.includes(searchFilter);
    ...
    form.addEventListener('submit', (e) => {
        ...
        formGroups.forEach(group => {
            ...
            if (input.required && !sanitizedValue) {
                ...
                isValid = false;
            } else if (input.type === 'email' && sanitizedValue && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(sanitizedValue)) {
                group.classList.add('error');
                isValid = false;
            } else if (input.id === 'phone' && sanitizedValue && !/^[0-9\-\+\(\)\s]+$/.test(sanitizedValue)) {
                group.classList.add('error');
                isValid = false;
        ...
        try {
            ...
            const formattedProperties = propertiesData.map((prop, index) => ({
                ...
                tags: prop.tags.map(tag => {
                    ...
                    if (tag.includes('Pet') || tag.includes('Family')) return 'Pet Friendly';
                    return tag;
                }),
                featured: index === 0
            }));

            const propertyFilter = new PropertyFilter(formattedProperties, '#properties-grid');
            propertyFilter.init();
